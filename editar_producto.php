        ...
        <form action="actualizar_producto.php" method="POST">
            ...
            <div class="form-group">
                ...
                <select name="categoria" required>
                    <?php
                    // Cargar categorías y marcar la correcta como seleccionada
                    ...
                    while ($cat = $res_cat->fetch_assoc()) {
                        ...
                        echo "<option value='" . $cat['id'] . "' $seleccionado>"
            ...
            <a
                href="inventario.php"
                style="display:block; text-align:center; margin-top:15px; color:#64748b; text-decoration:none;">
                Cancelar
            </a>
