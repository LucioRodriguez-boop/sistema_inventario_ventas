...
<body>
    ...
    <div class="container">
        ...
        <form action="guardar_proveedor.php" method="POST">
            ...
            <div class="form-group">
                <label for="empresa">Nombre de la Empresa (*):</label>
                <input type="text" id="empresa" name="empresa" required autocomplete="off" placeholder="Ej. Tech Data S.A.">
            </div>

            <div class="form-group">
                <label for="contacto">Nombre del Contacto:</label>
                <input type="text" id="contacto" name="contacto" autocomplete="off" placeholder="Ej. Juan Pérez (Ventas)">
            </div>

            <div class="form-group">
                <label for="telefono">Teléfono:</label>
                <input type="text" id="telefono" name="telefono" autocomplete="off" placeholder="Ej. 2222-3333">
            </div>

            <div class="form-group">
                <label for="direccion">Dirección Física:</label>
                <textarea id="direccion" name="direccion" rows="3" placeholder="Ubicación completa de la bodega o empresa..."></textarea>
            </div>
